...
it will generates some files as a result
  - [x] result.html&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;=> arranged styled urls can open in the browser
  - [x] result.js&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;=> all unique js files(you can download all the list and analyze it)
  - [x] fuzz.txt&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;=> all unique urls with its parameters(FUZZ)
  - [x] fuzz_uniq.txt&nbsp;&nbsp;=> only all unique query
